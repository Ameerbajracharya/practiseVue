<template>
  <section class="flex w-full">
      <div class="m-auto">
        ...
        <p class="text-3xl text-right mt-4 w-40 h-20 overflow-x-scroll" style="direction: rtl">{{ currentNum }}</p>
        <div class="h-10 w-40 overflow-x-scroll">
...
export default {
    setup(){
        ...
        function pressed(value){
            ...
            else if(value === 'c' || value === 'Backspace' || value === 'Delete') clear();
        ...
        function calculate() {
            if(selectedOperation.value === "*") currentNum.value = prevNum.value * currentNum.value;
            else if(selectedOperation.value === '+')  currentNum.value = +prevNum.value + +currentNum.value;
            else if(selectedOperation.value === '-')  currentNum.value = prevNum.value - currentNum.value;
            else if(selectedOperation.value === '/')  currentNum.value = prevNum.value / currentNum.value;
            prevNum.value = "";
